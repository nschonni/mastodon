...
Rails.application.routes.draw do
  ...
  authenticate :user, ->(u) { u.role&.can?(:view_devops) } do
  ...
  get '/users/:username', to: redirect('/@%{username}'), constraints: ->(req) { req.format.nil? || req.format.html? }
  get '/users/:username/statuses/:id', to: redirect('/@%{username}/%{id}'), constraints: ->(req) { req.format.nil? || req.format.html? }
